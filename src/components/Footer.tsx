        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            <Link to="/">
              <div className="rounded-lg px-2 py-1 w-fit">
                <img src={siteConfig.branding?.logoUrl || logo} alt={siteConfig.branding?.companyName || "Al Emad"} className="h-10 md:h-12 w-auto mb-0 object-contain" />
              </div>
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {(siteConfig.footerLinks || []).map((link: any) => (
